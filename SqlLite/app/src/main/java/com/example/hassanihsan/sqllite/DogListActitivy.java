...
public class DogListActitivy extends Activity implements OnClickListener, OnItemClickListener{
    ...
    private ArrayList<Dog> pojoArrayList;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        uGraduateNamesListView = (ListView) findViewById(R.id.DogListView);
        uGraduateNamesListView.setOnItemClickListener(this);



        pojoArrayList = new ArrayList<Dog>();
    ...
    public void onClick(View v) {
        Intent addNewUndergraduateIntent = new Intent(this, AddNewDogActivity.class);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        Intent updateDeleteUgraduateIntent = new Intent(this, MainActivity.class);
        ...
        //same array id.
       Dog clickedObject =  pojoArrayList.get(arg2);
