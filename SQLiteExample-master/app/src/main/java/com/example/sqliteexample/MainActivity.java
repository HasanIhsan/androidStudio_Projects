...
public class MainActivity extends AppCompatActivity {
    ...
    EditText editText_name,editText_email, editText_date;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stringName.length() <=0 || stringEmail.length() <=0 || stringDate.length() <= 0){
                    ...
                    EmployeeModelClass employeeModelClass = new EmployeeModelClass(stringName,stringEmail,stringDate);
